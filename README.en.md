...
- IPIP: International Personality Item Pool. [ipip.ori.org](https://ipip.ori.org/)

See [METHODOLOGY.en.md](METHODOLOGY.en.md) for the full scientific methodology (Spanish version: [METHODOLOGY.md](METHODOLOGY.md)).
